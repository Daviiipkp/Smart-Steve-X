...
public class AddTimeTriggerCommand extends Command {
    ...
    @Override
    public void execute() {
        System.out.println("Executing AddTimeTriggerCommand");
    ...
    public String getDescription() {
        return "Add triggers for any time. AI will be called automatically and receive context attributed to the response when the time comes. Usage example: " + getID() + "___" + LocalDateTime.now().plusHours(2);
    }
}
