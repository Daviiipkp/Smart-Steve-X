...
public class Configuration {
    ...
    //General
    public static String LLM_PROVIDER = "https://api.groq.com/openai/v1/chat/completions";
    public static String SEARCH_PROVIDER = "https://search.hackclub.com/res/v1/web/search";
    public static String MODEL_NAME = "openai/gpt-oss-120b";
    ...
    public static boolean VOICE_TYPING_FEATURE = true;
    public static boolean CLEAR_MEMO_ON_STARTUP = false;


    //Debug
    public static boolean SHOW_VOICE_TEXT_DEBUG = true;
    public static boolean MEMORY_DEBUG = false;
    public static boolean USER_PROMPT_DEBUG = false;
    public static boolean STEVE_RESPONSE_DEBUG = true;
    public static boolean DATABASE_SAVING_DEBUG = false;
    public static boolean FINAL_PROMPT_DEBUG = true;
    public static boolean PROMPT_LATENCY_DEBUG = true;
    public static boolean PROMPT_COMPONENTS_CONTENT_EMPTY_DEBUG = true;
    ...
    public static String VOICE_TYPING_STOP_STRING = "stop";
